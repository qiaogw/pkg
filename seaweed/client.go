...
func init() {
	...
	//copy.maxMB = &mb
	//copy.ttl = &s
	copy.concurrenctFiles = 8
	copy.concurrenctChunks = 8

}
func RunCopy(fileOrDirs []string, filerDestination string) error {
...
func (worker *FileCopyWorker) uploadFileDataAsOne(task FileCopyTask, f *os.File) error {
