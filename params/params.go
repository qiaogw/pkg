...
//GetResourceType 获取资源类别
func GetResourceType(subtype string) string {
	var txt string
	switch subtype {
	case "1":
		txt = "页面目录"
...
//GetStatus 获取数据状态
func GetStatus(subtype string) string {
	var txt string
	switch subtype {
	case "1":
		txt = "启用"
...
//GetRoleType 获取角色授权等级
func GetRoleType(subtype string) string {
	var txt string
	switch subtype {
	case "0":
		txt = "超级"
...
//GetBulletinType 获取公告类型
func GetBulletinType(subtype int) string {
	var txt string
	switch subtype {
	case 0:
		txt = "超级"
...
//GetFsmStatus 获取流程节点状态
func GetFsmStatus(subtype int) string {
	var txt string
	switch subtype {
	case 0:
		txt = "未开始"
